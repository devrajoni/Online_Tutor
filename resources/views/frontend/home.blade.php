            ...
            <div id="myCarousel" class="carousel slide slide-head" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="carousel-item carousel-img-1 active">
                  <div class="container">
                    <div class="carousel-caption mb-3 pb-3 mb-sm-5 pb-sm-5 carousel-para">
                      <h6 class="text-white">Here you can get private home tutor & Tutoring<br><a href="#">Read More...</a></h6>
                    </div>
                  </div>
                </div>
                <div class="carousel-item carousel-img-2">
                  <div class="container">
                    <div class="carousel-caption mb-3 pb-3 mb-sm-5 pb-sm-5 carousel-para">
                      <h6 class="text-white">The first online tutors database for the students who need tutors. Search for tutors and tuitions<br><a href="#">Read More...</a></h6>
                    </div>
                  </div>
                </div>
                <div class="carousel-item carousel-img-3">
                  <div class="container">
                    <div class="carousel-caption mb-3 pb-3 mb-sm-5 pb-sm-5 carousel-para">
                      <h6 class="text-white">Find the best teachers in your area<br><a href="#">Read More...</a></h6>
                    </div>
                  </div>
                </div>
              </div>
