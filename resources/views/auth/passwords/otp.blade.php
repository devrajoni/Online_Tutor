                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('submit-reset-password')}}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="number" class="form-control @error('phone') is-invalid @enderror" name="otp" value="{{ old('otp') }}" required autocomplete="phone" autofocus>
